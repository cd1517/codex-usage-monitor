<p align="center">
  <img src="./assets/readme/hero.svg" width="100%" alt="Comoni：将 Codex 剩余用量显示在 ChatGPT 对话区旁的 macOS 菜单栏应用">
</p>
...
Comoni 是一个独立的 macOS 菜单栏应用。它把 Codex 的 **5 小时**与**1 周**剩余用量贴在 ChatGPT 对话区右上方，无需打开设置，也不会抢走输入焦点。
