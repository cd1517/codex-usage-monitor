<p align="center">
  <img src="./assets/readme/hero.svg" width="100%" alt="Codex Usage Monitor: a macOS menu bar app that places Codex remaining usage in the ChatGPT title bar and opens details beneath it">
</p>

<p align="center">
  <a href="https://github.com/cd1517/codex-usage-monitor/releases/latest"><strong>Latest Release</strong></a>
  ·
...
Codex Usage Monitor is an independent macOS menu bar app. It places your remaining **5-hour** and **1-week** Codex usage in a compact strip integrated into the ChatGPT title bar. Hover over the strip to open a detail window directly beneath it—without opening settings or stealing keyboard focus.
...
```bash
curl -fsSL https://raw.githubusercontent.com/cd1517/codex-usage-monitor/main/scripts/install.sh | bash
```

Launch the app after installation:

```bash
open "/Applications/Codex Usage Monitor.app"
```

### Manual install

Download the DMG from [Releases](https://github.com/cd1517/codex-usage-monitor/releases/latest), then drag `Codex Usage Monitor.app` into Applications.
...
```text
Sources/
├── CodexUsageMonitorCore/       # Usage models, JSON-RPC, window and geometry logic
├── CodexUsageMonitorApp/        # Menu bar, overlay panels, and app lifecycle
└── CodexUsageMonitorCheck/      # Read-only live-check entry point
Tests/
└── CodexUsageMonitorCoreTests/  # Dependency-free test runner
```
