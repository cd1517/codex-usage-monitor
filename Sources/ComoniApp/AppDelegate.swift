...
final class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    private func configureStatusItem() {
        ...
        item.button?.image = NSImage(systemSymbolName: "bolt.circle", accessibilityDescription: "Comoni")
        ...
        let quitItem = NSMenuItem(title: "退出 Comoni", action: #selector(quit), keyEquivalent: "q")
